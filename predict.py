...
def show_model_param(model):
    ...
    for i in params:
        ...
        for j in i.size():
            l *= j
        print("Structure: {}, params: {}".format(str(list(i.size())), str(l)))
        k = k + l
    print("----------------------")
    print("num: " + str(k))
    ...
    while True:
        ...
        if ret:
            ...
            if video_writer is None:
                ...
                video_writer = cv2.VideoWriter(save_video_path, fourcc, fps=60, frameSize = (im0.shape[1], im0.shape[0]))
...
if __name__ == '__main__':
    ...
    model_path = './weights-yolov3-hand/latest.pt' # 检测模型路径
    model_cfg = 'yolo' # yolo / yolo-tiny 模型结构
    video_path = "./videos/test3.mp4" # 测试视频
